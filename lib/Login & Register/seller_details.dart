...
class SellerDetails extends StatefulWidget {
  ...
  SellerDetails({Key? key, required this.update, this.phoneNumber})
      : super(key: key);
...
class _SellerDetailsState extends State<SellerDetails> {
  ...
  getSellerData() async {
    ...
    SellerModel buyerData = sellerModelFromJson(data);
    phone.text = buyerData.phone;
    name.text = buyerData.name;
    shopname.text = buyerData.shopName;
    address.text = buyerData.address;
  ...
  initState() {
    ...
    if (widget.update) getSellerData();
  }
                ...
                children: [
                  ...
                  Center(
                    ...
                    onPressed: () async {
                      ...
                      } else if (shopname.text.trim().isEmpty) {
