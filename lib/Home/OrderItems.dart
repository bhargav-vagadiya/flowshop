        ...
        body: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
             ...
             // List image_path = item[index]['image_path'].toString().split(",");
              ...
              List itemPrice = item[index]['product_price'].toString().split(",");
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                for(int i=0;i<products.length;i++)
                                  Text("$curruncy${double.parse(itemPrice[i]) * double.parse(product_quantity[i])}"),
                              ],),
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(child: SizedBox()),
                            Text("$curruncy${item[index]['total_product_price']}")
                          ],
                        ),
                        Row(
                          children: [
                        ...
                        Row(
                          children: [
                            Text("Total:"),
                            Expanded(child: SizedBox()),
                            Text("$curruncy${item[index]['total_product_price']+item[index]['shipping_charge']}")
                          ],
                        )
                        //Expanded(child: SizedBox()),
